...
if __name__ == "__main__":
    ...
    csv_file = os.path.join(csv_dir, 'SPY.csv')

    # Download SPY data from Yahoo Finance
    spy_data = yf.download('SPY', start='2001-01-01', end='2006-01-01')

    # Save the data to a CSV file
    spy_data.to_csv(csv_file)
    print(f"Data for SPY from 2001-01-01 to 2006-01-01 saved to {csv_file}")
